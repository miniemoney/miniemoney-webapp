        ...
        <div className="flex flex-col justify-between h-full">
          ...
          <div className="flex flex-col gap-8 px-12">
            <div className="flex flex-col items-start gap-3">
              ...
              <h1 className="text-5xl text-white font-medium">for teenagers</h1>
            </div>
            <div className="flex flex-col items-start gap-6 pr-[80px]">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-[#D0D5DD]">
                    Access hundreds of resources and content to help your young
                    ones be money-wise
                  </p>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-4 ">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm text-[#475467]">
                Help your youngster or loved ones reach their financial goals by
                gifting them any amount of money towards their savings.
              </p>
            </div>
          </div>
          {renderStep(step)}
